...
private slots:
    ...
    void on_buttonGenerateNoise_clicked();

    void on_buttonGaussianFilter_clicked();

    void on_buttonMedianFilter_clicked();

    void on_buttonFastGaussianFilter_clicked();

    void on_buttonCanny_clicked();

    void on_buttonHoughCircle_clicked();

    void on_buttonReadModel_clicked();

    void on_buttonGeneralizedHough_clicked();
